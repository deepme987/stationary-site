		...
		<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #333; ">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
				<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
					<li class="nav-item"><a class="nav-link <?php if($_GET["page"]=="" || $_GET["page"]=="products"){echo 'active';}?>" href="index.php">Products <span class="sr-only">(current)</span></a></li>
					...
					<li class="nav-item"><a class="nav-link <?php if($_GET["page"]=="profile"||$_GET["page"]=="pass"){echo 'active';}?>" href="index.php?page=profile">Profile</a></li>
				</ul>
